...
# Template for the updated agent files
    ...
    for pin in PINS:
        ...
        try:
            ...
            if "unique_order_id=" in current_url:
                ...
                print(f"⚠️ Unknown result for PIN (after manual submit)")
...
# Update primary file
with open("boss_ai_playwright.py", "w", encoding='utf-8') as f:
    f.write(template.format(agent_name="PRIMARY"))

# Update A-Z files
for letter in string.ascii_uppercase:
    filename = f"boss_ai_playwright_{letter}.py"
    with open(filename, "w", encoding='utf-8') as f:
        f.write(template.format(agent_name=letter))
