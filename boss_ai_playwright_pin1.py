...
parser.add_argument('--confirmation', type=str, default="5727559423", help='Confirmation number')
parser.add_argument('--pins', type=str, default="1759,5585,2390,3008,2963", help='Comma-separated PINs')
