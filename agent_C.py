...
AGENT_NAME = "CHARLIE_HUNTER"
CONFIRMATION = "6160911170"  # Boss provided booking ID
AGENT_ID = "C"

# Load mission config
with open('mission.yml', 'r') as f:
...
WAIT_TIME = mission['mission_params']['wait_time']
HEADLESS = mission['mission_params']['headless']
...
with sync_playwright() as p:
    ...
    proxy_config = {
        "server": mission['mission_params']['proxy_server'],
        "username": mission['mission_params']['proxy_username'],
        "password": mission['mission_params']['proxy_password']
    }
