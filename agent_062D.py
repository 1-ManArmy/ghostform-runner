...
# -*- coding: utf-8 -*-
"""
🎯 GHOSTFORM AGENT 062D
Batch: D | Agent: 62
Target: 6339614781
PINs: 5609, 6980, 7955, 5480, 3455
"""
...
print(f"🔑 Assigned PINs: 5609, 6980, 7955, 5480, 3455")
...
with sync_playwright() as p:
    ...
    for i, pin in enumerate(PINS, 1):
        ...
        try:
            ...
            # Enhanced error detection using your selector
        ...
        # Behavior-based pause: just continue to next PIN immediately
        if i < len(PINS):
